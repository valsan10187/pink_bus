...
<body>
    ...
    <div class="row">
        ...
        <h2 class="text-info mb-5 text-center" >Search Bus Route</h2><hr>
...
<tr><td><?php echo $Bno?></td>
    ...
    <td><button type="submit" class=" btnx btn btn-primary " onclick="x('<?php echo $Bno?>')" name="book" data-bs-toggle="modal" data-bs-target="#staticBackdrop" >Book</button>
        </td>
